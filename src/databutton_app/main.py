...
from databutton_app.exceptionmodel import ExceptionModel
from databutton_app.pathutils import convert_exception_to_model
...
# NB: Name of this function becomes a property of the brain client and callable by the user web app
def check_health(
